...
export class Backend implements backendInterface {
    ...
    async getAllPersonalityTypes(): Promise<Array<PersonalityType>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPersonalityTypes();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getPersonalityType(arg0: string): Promise<PersonalityType> {
        if (this.processError) {
            try {
                const result = await this.actor.getPersonalityType(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
